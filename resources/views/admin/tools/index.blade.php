<x-layout.default>
                                    ...
                                    <div class="p-5">
                                        <form @submit.prevent="saveUser">
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <textarea id="content_prompt" placeholder="Enter Content Prompt"
                                                    class="form-input" x-model="params.content_prompt"></textarea>
                                            </div>
                                            <div class="mb-5">
                                            ...
                                            <div class="mb-5">
                                                <label for="deadline">Deadline</label>
                                                 ...
                                                 <input id="deadline" type="text" placeholder="Enter Deadline"
                                                    class="form-input" x-model="params.deadline" />
                                            </div>

                                            <div class="mb-5">
                                                <label for="supplier">Supplier</label>
                                                <input id="supplier" type="text" placeholder="Enter Supplier"
                                                    class="form-input" x-model="params.supplier" />
                                            </div>
                        ...
                        <tbody>
                            <template x-for="contact in filterdContactsList" :key="contact.id">
                                <tr>
                                    ...
                                    <td x-text="contact.content_prompt"></td>
                                    <td x-text="contact.budget" class="whitespace-nowrap"></td>
                                    <td x-text="contact.deadline" class="whitespace-nowrap"></td>
                                    <td x-text="contact.supplier" class="whitespace-nowrap"></td>
                                    <td x-text="contact.goals ? contact.goals.map(g => g.name).join(', ') : ''" class="whitespace-nowrap"></td>
                                    <td>
                        ...
                        <div class="px-6 pb-24 -mt-10 relative">
                            ...
                            <div class="mt-6 grid grid-cols-1 gap-4 ltr:text-left rtl:text-right">
                                <div class="flex items-center">
                                    <div class="flex-none ltr:mr-2 rtl:ml-2">Content Prompt :</div>
                                    <div class="truncate text-white-dark" x-text="contact.content_prompt"></div>
                                </div>
                                <div class="flex items-center">
    ...
    filterdContactsList: [],
    loading: false,
    allGoals: [], // Assuming you have a list of goals to display
    defaultParams: {
        id: null,
        name: '',
        content_prompt: '',
        ...
        if (user) {
            this.params = JSON.parse(JSON.stringify(user));
             if (user.goals && Array.isArray(user.goals)) {
                this.params.goal_ids = user.goals.map(g => g.id);
            }
        }
    ...
    async saveUser() {
        ...
        console.log("checking params", !this.params.budget, !this.params.deadline, !this.params.name, !this.params.content_prompt);
         ...
         if (!this.params.name || !this.params.content_prompt || this.params.budget === null || this.params.budget === '' ||
    this.params.deadline === null || this.params.deadline === '') {
            this.showMessage("All fields are required.", "error");
            return;
        }

        const isUpdate = !!this.params.id;
        const url = isUpdate ? `/admin/tools/${this.params.id}` : `/admin/tools`;
        ...
        formData.append('content_prompt', this.params.content_prompt);
        formData.append('budget', this.params.budget);
        formData.append('deadline', this.params.deadline);
        formData.append('supplier', this.params.supplier);
        this.params.goal_ids.forEach(id => {
            formData.append('goal_ids[]', id);
        });
    ...
    async deleteUser(user) {
        ...
        try {
            const response = await fetch(`/admin/tools/${user.id}`, {
                method: "DELETE",
                headers: {
